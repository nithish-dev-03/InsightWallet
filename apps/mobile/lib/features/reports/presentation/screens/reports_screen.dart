...
class _ReportsContent extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: Insets.lg),
        _buildExpenseBreakdownSection(context, isDark, currencySymbol),
        const SizedBox(height: Insets.lg),
        _buildTopCategoriesSection(context, isDark, currencySymbol),
        const SizedBox(height: Insets.lg),
        _buildAISmartInsights(context, isDark, currencySymbol),
        const SizedBox(height: Insets.lg),
  ...
  Widget _buildCashFlowTrendSection(
      BuildContext context, bool isDark, String currencySymbol) {
    final primaryColor =
        isDark ? const Color(0xFFD2BBFF) : const Color(0xFF3525CD);
    final tertiaryColor =
    ...
    final displayIncome =
        report.totalIncome == 0.0 ? 12450.00 : report.totalIncome;
    final displayExpense =
        report.totalExpense == 0.0 ? 8210.45 : report.totalExpense;
                  ...
                  child: Column(
                    children: [
                      _buildBreakdownLegend(
                          context, 'Housing', '45%', primaryColor),
                      const Divider(height: 16, thickness: 0.5),
                      _buildBreakdownLegend(
                          context, 'Food', '28%', tertiaryColor),
                      const Divider(height: 16, thickness: 0.5),
                      _buildBreakdownLegend(
                          context, 'Other', '27%', secondaryContainer),
                    ],
                  ),
                ),
              ],
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    '$currencySymbol${spent.toInt()} / $currencySymbol${budget.toInt()}',
                    style: AppTypography.bodySm.copyWith(
                      color: Theme.of(context).colorScheme.onSurfaceVariant,
                    ),
                  ),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInsightCard(
            ...
            body:
                'You spent 18% more on Food this month compared to your 3-month average.',
          ...
          _buildInsightCard(
            ...
            body:
                "Switching to the 'Premium Plus' savings plan could earn you \${currencySymbol}125 extra in interest this year.",
          ...
          _buildInsightCard(
            ...
            body:
                "InsightStream renews tomorrow. You haven't used this service in 3 weeks.",
  ...
  BarChartGroupData _makeBarGroup(
      int x, double income, double expense, Color primary, Color tertiary) {
